...
void showQuestion(int num, int type) {
    ...
    switch (type) {
        ...
        case 2:
            ...
            break;
        case 3:
            printf("%s", idioms_type3_arr[num].new_explain);
            break;
        default:
...
char showOption(int num, int type) {
    ...
    switch (type) {
        ...
        case 2:
            ...
            break;
        case 3:
            option = idioms_type3_arr[num].answer;
            word = idioms_type3_arr[num].homophonic;
            break;
        default:
            printf("error: unknown type —— 未知的题目类型");
            break;
...
void showAnswer(int num, int type) {
    ...
    switch (type) {
        ...
        case 2:
            ...
            break;
        case 3:
            printf("%c", idioms_type3_arr[num].answer);
            printf("%s", idioms_type3_arr[num].homophonic);
            break;
        default:
            printf("error: unknown type —— 未知的题目类型");
            break;
    ...
    switch (type) {
        ...
        case 2:
            ...
            break;
        case 3:
            printf("%s", idioms_type3_arr[num].explain);
            // 在画布上显示新释义
            gotoxy(6, 16);
            printf("新释义：");
            printf("%s", idioms_type3_arr[num].new_explain);
